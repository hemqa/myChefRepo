...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "durgadas-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/dkchef"
  #   chef.validation_client_name = "dkchef-validator"
  #   chef.validation_key_path = ".chef/dkchef-validator.pem"
  # end
end
